...
const Navbar = () => {
  ...
  return (
    <div className="w-full py-2 border-b-[1px] border-b-zinc-500 bg-white text-zinc-600 sticky top-0 z-50 bg-white/80 backdrop-blur-2xl">
      <div className="order-first flex-wrap max-w-screen-xl mx-auto h-full flex items-center px-4 xl:px-0">
        {/* Logo */}
        <Logo />
        {/* Navigation */}
        <ul className="order-last text-xs sm:text-sm flex-1  md:order-none w-full md:w-fit flex py-2 items-center gap-5 text-sm uppercase font-semibold">
          {navigation.map((item) => (
