...
const Categories = ({ categories, setCategoryName, openSidebar, setOpenSidebar, products }) => {
  ...
  return (
    <div className={`flex ${openSidebar ? " w-[320px] " : "w-0 "} h-full border border-1 pt-0 shadow-xl absolute left-0 top-0 z-10 overflow-hidden ease-in-out duration-500 transition-all`}>
