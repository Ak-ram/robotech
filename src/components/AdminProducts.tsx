                ...
                <table className="min-w-full border border-gray-300 text-sm">
                  <thead>
                    <tr className="bg-zinc-800 text-white ">
                      ...
                      <th className="max-w-[150px] whitespace-nowrap text-ellipses border px-4 py-2">Image2</th>
                      <th className="max-w-[150px] whitespace-nowrap text-ellipses border px-4 py-2">Image3</th>
                      <th className="max-w-[150px] whitespace-nowrap text-ellipses border px-4 py-2">Description</th>
                      <th className="max-w-[150px] whitespace-nowrap text-ellipses border px-4 py-2">Count</th>
                      <th className="max-w-[150px] whitespace-nowrap text-ellipses border px-4 py-2">Brand</th>
                    ...
                    {jsonData[selectedSectionIndex][selectedCat!]?.map(
                      (item: any, itemIndex: number) => (
                        <tr key={itemIndex} className="hover:bg-slate-100">
                          ...
                          <td className="max-w-[150px] whitespace-nowrap overflow-x-auto text-ellipses order px-4 py-2">{item.description}</td>
