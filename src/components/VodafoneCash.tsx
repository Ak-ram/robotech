const VodafoneCash = ({ isVodafoneCashOpened, setIsVodafoneCashOpened }) => {
    return (
        <>
            <div className={`${isVodafoneCashOpened ? "flex" : "hidden"} w-full h-full top-0 left-0 flex items-center justify-center backdrop-blur-2xl fixed mt-8 lg:m-0 items-center justify-center bg-gray-100`}>
