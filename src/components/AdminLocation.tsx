...
const AdminLocation = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const data = await fetchJsonData("robotech/pages/location.json");
                setJsonArray(data);
            } catch (error) {
    ...
    const handleEditSubmit = async () => {
        ...
        if (
            !editedItem.locationText ||
            !editedItem.locationUrl
        ) {
                        ...
                        <tbody>
                            {jsonArray.map((item, index) => (
                                <tr key={index} className="hover:bg-slate-100">
                                    <td className="text-center font-semibold max-w-[150px] whitespace-nowrap overflow-x-auto text-ellipses border px-4 py-2">{item.locationText}</td>
                    ...
                    <div className="bg-white max-h-[700px] overflow-auto min-w-[600px] p-8 rounded-lg shadow-md">
                        ...
                        <div className="">
                            ...
                            <div className=" mb-2 lg:pr-4">
                                <span className="text-sm font-bold my-2 -ml-2">locationText</span>
