...
//         // Group courses transactions by day, month, and year
...
//         // Group print services transactions by day, month, and year
...
//       }
//       dailyRevenue[dayKey] += transaction.price;

//       if (!monthlyRevenue[monthKey]) {
//         monthlyRevenue[monthKey] = 0;
//       }
//       monthlyRevenue[monthKey] += transaction.price;

//       if (!yearlyRevenue[yearKey]) {
//         yearlyRevenue[yearKey] = 0;
//       }
//       yearlyRevenue[yearKey] += transaction.price;
//     });

//     // Add course revenue to daily, monthly, and yearly revenue
...
//         dailyRevenue[dayKey] = 0;
//       }
//       dailyRevenue[dayKey] += course.price;

//       if (!monthlyRevenue[monthKey]) {
//         monthlyRevenue[monthKey] = 0;
//       }
//       monthlyRevenue[monthKey] += course.price;

//       if (!yearlyRevenue[yearKey]) {
//         yearlyRevenue[yearKey] = 0;
//       }
//       yearlyRevenue[yearKey] += course.price;
//     });

//     // Add print service revenue to daily, monthly, and yearly revenue
...
//         dailyRevenue[dayKey] = 0;
//       }
//       dailyRevenue[dayKey] += printService.price;

//       if (!monthlyRevenue[monthKey]) {
//         monthlyRevenue[monthKey] = 0;
//       }
//       monthlyRevenue[monthKey] += printService.price;

//       if (!yearlyRevenue[yearKey]) {
//         yearlyRevenue[yearKey] = 0;
//       }
//       yearlyRevenue[yearKey] += printService.price;
//     });
//   });
